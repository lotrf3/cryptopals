...
public class MD4 extends MessageDigest {
	...
	/**
	 * The initial values of the four registers. RFC gives the values in LE so
	 * we converted it as JAVA uses BE endianness.
	 */
	 ...
	 * bytes as necessary to make the buffer length a multiple of 64 bytes. The
	 * last 8 bytes will be filled with the length of the buffer in bits. If
	 * there's no room to store the length in bits in the block i.e the block is
	 * larger than 56 bytes then an additionnal 64-bytes block is appended.
	 * 
